...
from Img2hashtag.img2hastag.core.filtering.llava_captioning import process_captioning
...
def main(config_path: str = "configs/config.yml"):
    ...
    llava_proc, llava_model = process_captioning.__globals__['load_img_to_text_model'](
    ...
    for category in ["cafe_img_dir", "restaurant_img_dir", "attraction_img_dir"]:
        ...
        process_captioning(json_dir=str(json_dir), processor=llava_proc, model=llava_model,
                           prompt=cfg['captioning']['llava_prompt'], device=device,
